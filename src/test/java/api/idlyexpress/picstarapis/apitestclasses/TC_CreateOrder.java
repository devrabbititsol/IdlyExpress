package api.idlyexpress.picstarapis.apitestclasses;
...
import api.idlyexpress.picstarapis.apipageclasses.CreateNewOrderDataset;
public class TC_CreateOrder extends BaseClass {

	private Logger logger;
	private ConfigFilesUtility configFileObj;

	public TC_CreateOrder() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_CreateOrder.class);
		configFileObj= new ConfigFilesUtility();
		configFileObj.loadPropertyFile("TC_CreateOrder.properties");
	}
	...
	public void doRequest() throws Exception { 
		...
		/*--------------------- POST --------------------- */
			...
			if(isExecutionFlag) {
 			 	Object object = (Object) new CreateNewOrderDataset();
